...
// ReSharper disable once RedundantCast
                        {MetadataConditionAddin.TargetProperty,(string)cmb_Properties.SelectedItem}
                    };
        ...
        void cmb_Properties_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                    {MetadataConditionAddin.TargetType, SystemProperties.GetPropertyDescription(propertyName).ValueType.FullName}
                };
        ...
        void UpdateForm()
        {
            ...
            var name = _configuration.TryGetValue<string>(MetadataConditionAddin.TargetProperty);
            if (name == null)
            {
                return;
            }
            ...
            var propertyName = _configuration.TryGetValue<string>(MetadataConditionAddin.TargetProperty);
